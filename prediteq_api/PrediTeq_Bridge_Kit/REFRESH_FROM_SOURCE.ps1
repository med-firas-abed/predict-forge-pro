...
Copy-Item (Join-Path $sourceScripts "run_relay_csv_rehearsal.sh") (Join-Path $root "run_relay_csv_rehearsal.sh") -Force
Copy-Item (Join-Path $sourceScripts "run_relay_real_csv.sh") (Join-Path $root "run_relay_real_csv.sh") -Force
