...
const FRENCH_PHRASE_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/pr[ée]diction live issue du mod[eè]le ml/gi, "lecture calculée à partir des signaux machine"],
  [/source simulator_demo/gi, "source simulée"],
  [/replay d[ée]mo calibr[ée]/gi, "source simulée"],
  [/lecture d[ée]mo/gi, "source simulée"],
  [/pipeline live/gi, "flux en direct"],
  ...
  [/source persisted_reference/gi, "source référence stable"],
  ...
  [/agent ia separe/gi, "module séparé"],
  [/rapport ia/gi, "rapport PrediTeq"],
  [/vue jury|vue technicien|vue double/gi, ""],
  [/contexte scenario/gi, "contexte machine"],
  [/diagnostic avanc[ée]/gi, "diagnostic détaillé"],
];
...
const FRENCH_WORD_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/\btemperature\b/g, "température"],
  [/\bHumidite\b/g, "Humidité"],
  [/\bhumidite\b/g, "humidité"],
  [/\bDuree\b/g, "Durée"],
  [/\bduree\b/g, "durée"],
  [/\bRecente\b/g, "Récente"],
  [/\brecente\b/g, "récente"],
  [/\bRecemment\b/g, "Récemment"],
  [/\brecemment\b/g, "récemment"],
  [/\bFraiche\b/g, "Fraîche"],
  [/\bfraiche\b/g, "fraîche"],
