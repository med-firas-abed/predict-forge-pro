...
export const MACHINES: Machine[] = [
  { id: "ASC-A1", name: "Stockeur vertical rotatif A1", loc: "Bâtiment A — Zone Nord", city: "Ben Arous", lat: 36.754, lon: 10.231, hi: 0.96, rul: 142, rulci: 24, status: "ok", vib: 1.3, curr: 4.21, temp: 23.4, anom: 1, cycles: 82, model: "SITI FC100L1-4", floors: 19, last: "2026-03-15" },
  { id: "ASC-B2", name: "Stockeur vertical rotatif B2", loc: "Bâtiment B — Zone Est", city: "Sfax", lat: 34.739, lon: 10.760, hi: 0.62, rul: 54, rulci: 16, status: "degraded", vib: 3.1, curr: 4.68, temp: 27.1, anom: 7, cycles: 74, model: "SITI FC100L1-4", floors: 19, last: "2026-03-10" },
  { id: "ASC-C3", name: "Stockeur vertical rotatif C3", loc: "Bâtiment C — Zone Sud", city: "Sousse", lat: 35.828, lon: 10.636, hi: 0.10, rul: 12, rulci: 7, status: "critical", vib: 6.8, curr: 4.97, temp: 31.2, anom: 23, cycles: 61, model: "SITI FC100L1-4", floors: 19, last: "2026-03-20" },
];
