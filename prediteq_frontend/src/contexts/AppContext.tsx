...
const TR: Record<string, Record<Lang, string>> = {
  ...
  "dash.avgHI": { fr: "Indice de santé moyen (HI)", en: "Average machine health (HI)", ar: "متوسط مؤشر الصحة" },
  ...
  "dash.hiEvolution": { fr: "Évolution de l'indice de santé", en: "Machine health evolution", ar: "تطور مؤشر الصحة" },
  ...
  "mach.hi": { fr: "Indice de santé (0–1)", en: "Machine health (0–1)", ar: "مؤشر الصحة (0–1)" },
  ...
  "meta.seuils.sub": { fr: "Regles d'alerte et notifications", en: "Alert rules and notifications", ar: "قواعد التنبيه والإشعارات" },
  ...
  "modal.rulEstimated": { fr: "Marge restante (RUL)", en: "Remaining margin (RUL)", ar: "العمر المتبقي المقدّر" },
  "modal.rulSurveillance": { fr: "Surveillance", en: "Monitoring", ar: "مراقبة" },
  "modal.rulNoPrecursor": { fr: "Référence stable active", en: "Stable reference active", ar: "مرجع ثابت نشط" },
