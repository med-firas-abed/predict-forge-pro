...
const TR: Record<string, TranslationEntry> = {
  ...
  "nav.ia": { fr: "Analyse & Rapport IA", en: "AI Analysis & Reporting", ar: "ØªØ­Ù„ÙŠÙ„ ÙˆØªÙ‚Ø§Ø±ÙŠØ± Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ" },
  "nav.rapportIA": { fr: "Rapport IA", en: "AI Report", ar: "ØªÙ‚Ø±ÙŠØ± Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ" },
  "nav.planner": { fr: "Assistant IA", en: "AI Planner", ar: "ÙˆÙƒÙŠÙ„ Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ" },
  ...
  "admin.generateReport": { fr: "GÃ©nÃ©rer rapport IA", en: "Generate AI Report", ar: "Ø¥Ù†Ø´Ø§Ø¡ ØªÙ‚Ø±ÙŠØ± Ø°ÙƒØ§Ø¡ Ø§ØµØ·Ù†Ø§Ø¹ÙŠ" },
  ...
  "meta.ia.title": { fr: "Analyse & Rapport IA", en: "AI Analysis & Reporting", ar: "ØªØ­Ù„ÙŠÙ„ ÙˆØªÙ‚Ø§Ø±ÙŠØ± Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ" },
  "meta.ia.sub": { fr: "Analyse assistÃ©e, dÃ©cision et rapports intelligents", en: "Assisted analysis, decision support, and smart reports", ar: "ØªØ­Ù„ÙŠÙ„ Ù…Ø³Ø§Ø¹Ø¯ ÙˆØ¯Ø¹Ù… Ø§Ù„Ù‚Ø±Ø§Ø± ÙˆØªÙ‚Ø§Ø±ÙŠØ± Ø°ÙƒÙŠØ©" },
  "meta.rapportia.title": { fr: "Rapport IA", en: "AI Report", ar: "ØªÙ‚Ø±ÙŠØ± Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ" },
  "meta.rapportia.sub": { fr: "Rapports intelligents et plan d'action IA", en: "Smart reports and AI action planning", ar: "ØªÙ‚Ø§Ø±ÙŠØ± Ø°ÙƒÙŠØ© ÙˆØ®Ø·Ø© Ø¹Ù…Ù„ Ø¨Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ" },
  ...
  "meta.planner.title": { fr: "Agent IA", en: "AI Planner", ar: "ÙˆÙƒÙŠÙ„ Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ" },
  "meta.planner.sub": { fr: "Planification autonome de la maintenance par intelligence artificielle", en: "AI-powered autonomous maintenance planning", ar: "ØªØ®Ø·ÙŠØ· Ø§Ù„ØµÙŠØ§Ù†Ø© Ø§Ù„Ø°Ø§ØªÙŠ Ø¨Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ" },
  ...
  // Chat widget
  "chat.title": { fr: "Assistant PrediTeq", en: "PrediTeq Assistant", ar: "Ù…Ø³Ø§Ø¹Ø¯ PrediTeq" },
  "chat.subtitle": { fr: "Posez vos questions sur la flotte", en: "Ask about your fleet", ar: "Ø§Ø³Ø£Ù„ Ø¹Ù† Ø£Ø³Ø·ÙˆÙ„Ùƒ" },
  "chat.greeting": { fr: "Je suis votre assistant IA. Posez-moi une question sur vos machines ! ðŸš€", en: "I'm your AI assistant. Ask me anything about your machines! ðŸš€", ar: "Ø£Ù†Ø§ Ù…Ø³Ø§Ø¹Ø¯Ùƒ Ø§Ù„Ø°ÙƒÙŠ. Ø§Ø³Ø£Ù„Ù†ÙŠ Ø¹Ù† Ø¢Ù„Ø§ØªÙƒ! ðŸš€" },
  "chat.welcome": { fr: "Bonjour ! Je suis l'assistant IA de PrediTeq. Je peux vous renseigner sur l'Ã©tat de vos machines, les alertes, et la maintenance.", en: "Hello! I'm the PrediTeq AI assistant. I can help you with machine status, alerts, and maintenance.", ar: "Ù…Ø±Ø­Ø¨Ø§! Ø£Ù†Ø§ Ù…Ø³Ø§Ø¹Ø¯ PrediTeq Ø§Ù„Ø°ÙƒÙŠ. ÙŠÙ…ÙƒÙ†Ù†ÙŠ Ù…Ø³Ø§Ø¹Ø¯ØªÙƒ ÙÙŠ Ø­Ø§Ù„Ø© Ø§Ù„Ø¢Ù„Ø§Øª ÙˆØ§Ù„ØªÙ†Ø¨ÙŠÙ‡Ø§Øª ÙˆØ§Ù„ØµÙŠØ§Ù†Ø©." },
  ...
  // Planner
  "planner.title": { fr: "Agent de Planification IA", en: "AI Planning Agent", ar: "ÙˆÙƒÙŠÙ„ Ø§Ù„ØªØ®Ø·ÙŠØ· Ø§Ù„Ø°ÙƒÙŠ" },
  "planner.subtitle": { fr: "Analyse la flotte, propose les prochaines actions et prÃ©pare les tÃ¢ches de maintenance", en: "Analyses the fleet, suggests next actions, and prepares maintenance tasks", ar: "ÙŠØ­Ù„Ù„ Ø§Ù„Ø£Ø³Ø·ÙˆÙ„ ÙˆÙŠÙ‚ØªØ±Ø­ Ø§Ù„Ø®Ø·ÙˆØ§Øª Ø§Ù„ØªØ§Ù„ÙŠØ© ÙˆÙŠØ­Ø¶Ù‘Ø± Ù…Ù‡Ø§Ù… Ø§Ù„ØµÙŠØ§Ù†Ø©" },
  ...
  "planner.clickGenerate": { fr: "Cliquez sur GÃ©nÃ©rer pour lancer l'agent IA", en: "Click Generate to run the AI agent", ar: "Ø§Ù†Ù‚Ø± Ø¹Ù„Ù‰ Ø¥Ù†Ø´Ø§Ø¡ Ù„ØªØ´ØºÙŠÙ„ ÙˆÙƒÙŠÙ„ Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ" },
  ...
  // Rapport IA extra
  "rapport.title": { fr: "Rapport IA", en: "AI Report", ar: "ØªÙ‚Ø±ÙŠØ± Ø§Ù„Ø°ÙƒØ§Ø¡ Ø§Ù„Ø§ØµØ·Ù†Ø§Ø¹ÙŠ" },
